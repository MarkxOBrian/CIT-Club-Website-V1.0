...
<h4><center><div class="glyphicon glyphicon-user"></div> REGISTRATION FEE PAYMENT</center></h4>
</div>
...
<center><button type="button" class="btn btn-primary contact-btn" onclick="location.reload()">BACK</button>
<button class="btn btn-primary" type="submit" name="submit">PAY!</button></center>
<!--</div>-->
</div>
